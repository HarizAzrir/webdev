    ...
    <div class="hidden md:flex flex-col w-64 bg-gray-800">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            <nav class="flex-1 px-2 py-4 bg-gray-800">
                <a href="{{route('adminhomepage')}}" class="flex items-center px-4 py-2 text-gray-100 hover:bg-gray-700">
        ...
        <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="president" id="president" placeholder="Enter President"
                            value="{{ $club->president }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
